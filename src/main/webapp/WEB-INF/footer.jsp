			...
			<div class="container">
				...
				<div class="col-xs-12 col-sm-6 no-padding">
					<div class="clearfix payment-methods">
						<ul>
							<li><img src="${pageContext.request.contextPath}/assets/images/payments/1.png" alt=""></li>
							<li><img src="${pageContext.request.contextPath}/assets/images/payments/2.png" alt=""></li>
							<li><img src="${pageContext.request.contextPath}/assets/images/payments/3.png" alt=""></li>
							<li><img src="${pageContext.request.contextPath}/assets/images/payments/4.png" alt=""></li>
							<li><img src="${pageContext.request.contextPath}/assets/images/payments/5.png" alt=""></li>
						</ul>
					</div>
					<!-- /.payment-methods -->
				</div>
