					...
					<div class="navbar-collapse collapse"
						...
						<div class="nav-outer">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown mega-menu"><a href="category.html"
									data-hover="dropdown" class="dropdown-toggle"
